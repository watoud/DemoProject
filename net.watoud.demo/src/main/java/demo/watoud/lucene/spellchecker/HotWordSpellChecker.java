...
public class HotWordSpellChecker implements java.io.Closeable
{
		...
		synchronized (modifyCurrentIndexLock)
		{
			...
			if (!DirectoryReader.indexExists(spellIndexDir))
			{
				IndexWriter writer = new IndexWriter(spellIndexDir,
						new IndexWriterConfig(Constants.CURRENT_LUCENE_VERSION,
								null));
				writer.close();
			}
	 ...
	 *      float)
	 */
	public HotWord[] suggestSimilar(String word, int numSug, float accuracy)
			throws IOException
	{
		return this.suggestSimilar(word, numSug, null, null,
	 ...
	 * 
	 */
	public HotWord[] suggestSimilar(String word, int numSug, IndexReader ir,
			...
			throws IOException
	{
		...
		try
		{
			...
			for (int i = sugQueue.size() - 1; i >= 0; i--)
			{
				...
				list[i] = new HotWord(suggestHotWord.word,
						suggestHotWord.weight);
			}
	...
	public void clearIndex() throws IOException
	{
		synchronized (modifyCurrentIndexLock)
		{
			...
			final IndexWriter writer = new IndexWriter(dir,
					new IndexWriterConfig(Constants.CURRENT_LUCENE_VERSION,
							null).setOpenMode(OpenMode.CREATE));
			writer.close();
			swapSearcher(dir);
		}
	}
		...
		synchronized (modifyCurrentIndexLock)
		{
			...
			try
			{
				...
				terms: while ((currentTerm = iter.next()) != null)
				{
					...
					Document doc = createDocument(word, weight, getMin(len),
							getMax(len));
	...
	private static Document createDocument(String text, long weight, int ng1,
			int ng2)
	{
